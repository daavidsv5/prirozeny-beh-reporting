...
export const METRICS: MetricDefinition[] = [
  ...
  },
  {
    ...
    where: ["Roční přehled", "Měsíční přehled", "Hlavní KPI", "Marketingový Mix & PNO"],
    benchmark: { text: "Obuv v CZ orientačně 10 až 18 %; vyšší AOV snese nižší PNO než levné zboží. Tvrdá hranice je, že PNO musí být nižší než Marže %, jinak marketing prodělává.", min: 10, max: 18, better: "lower" },
  ...
  },
  {
    ...
    note: "Retenční analýza zobrazuje LTV s DPH, Hlavní KPI, Měsíční a Roční přehled bez DPH.",
